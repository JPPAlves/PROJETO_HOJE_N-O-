<!--Criando as paginas serviçõs e termos-->
<!DOCTYPE html>
<html lang="pt-br">
...
<head>
    ...
    <!--Estilizando as paginas serviçõs e termos-->
    <style>
    body {
...
<body>
    ...
    <h2> <b>Política Privacidade</b></h2>
    <p>A sua privacidade é importante para nós. É política do HOJE NÃO! respeitar a sua privacidade em relação a
        qualquer informação sua que possamos coletar no site HOJE NÃO!</a>, e
    ...
    <h2><b>Política de Cookies HOJE NÃO!</b></h2>
    ...
    <h3><b>Como usamos os cookies?</b></h3>
    ...
    <h3><b>Cookies que definimos</b></h3>
    <ul>
    ...
    <h3><b>Cookies de Terceiros</b></h3>
    ...
    <h3><b>Compromisso do Usuário</b></h3>
    <p>O usuário se compromete a fazer uso adequado dos conteúdos e da informação que o HOJE NÃO! oferece no site e com
    ...
    <ul>
        ...
        <li>B) Não difundir propaganda ou conteúdo de natureza racista, xenofóbica,
            jogos de hoje</a> ou azar, qualquer tipo de pornografia ilegal, de apologia ao terrorismo ou contra os
            direitos humanos;</li>
        <li>C) Não causar danos aos sistemas físicos (hardwares) e lógicos (softwares) do HOJE NÃO!, de seus
